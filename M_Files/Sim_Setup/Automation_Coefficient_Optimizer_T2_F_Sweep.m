...
%for cntr=1:sim_pts
    for cntr1=1:sim_pts_f_SR
        ...
        Slip_Err_P_Gain = 56000
        Tau_SRC = 1/(2*pi*(10^(-3.0625 + cntr1/16)))
...
Filename_ABS = sprintf('Sliding_Mode_Control_ABS_Test_ABS_Test_175Nm_T2_%s.mat', datestr(now,'mm-dd-yyyy_HH-MM'));
save(Filename_ABS);
